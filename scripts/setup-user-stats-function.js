...
async function createUserStatsFunction() {
  ...
  try {
    ...
    console.log('');
    console.log('📌 Note: The service already has fallback logic, so the profile page will work');
    console.log('   even without this function, but performance will be slower.');
