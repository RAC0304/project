...
async function addTestReviews() {
  try {
    ...
    const testReviews = [
      {
        ...
        content: 'Had a wonderful time with this tour guide. Very knowledgeable and friendly.',
        is_verified: true,
      ...
      },
      {
        ...
        rating: 4,
        title: 'Great Tour!',
        content: 'Really enjoyed the tour. Would definitely recommend to others.',
        is_verified: true,
      ...
      },
      {
        ...
        content: 'Very professional and made the tour very interesting. Highly recommended!',
        is_verified: true,
    ...
    console.log('Verification - total reviews for tour guide:', verifyReviews?.length);
