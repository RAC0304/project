-- Itinerary System Migration Script for Supabase (Fixed for BIGINT compatibility)
-- This script sets up the complete itinerary system with all required tables and relationships

-- Create sequences for BIGINT IDs
CREATE SEQUENCE IF NOT EXISTS itineraries_id_seq;
CREATE SEQUENCE IF NOT EXISTS itinerary_days_id_seq;
CREATE SEQUENCE IF NOT EXISTS itinerary_activities_id_seq;
CREATE SEQUENCE IF NOT EXISTS itinerary_destinations_id_seq;
CREATE SEQUENCE IF NOT EXISTS itinerary_images_id_seq;
CREATE SEQUENCE IF NOT EXISTS itinerary_bookings_id_seq;
CREATE SEQUENCE IF NOT EXISTS itinerary_requests_id_seq;
CREATE SEQUENCE IF NOT EXISTS itinerary_reviews_id_seq;
CREATE SEQUENCE IF NOT EXISTS itinerary_tags_id_seq;
CREATE SEQUENCE IF NOT EXISTS itinerary_tag_relations_id_seq;
...
DROP FUNCTION IF EXISTS get_itinerary_stats();
...
DROP FUNCTION IF EXISTS search_itineraries(TEXT, TEXT, TEXT, INTEGER);
...
DROP FUNCTION IF EXISTS get_itinerary_details(TEXT);
...
DROP FUNCTION IF EXISTS has_user_reviewed_itinerary(BIGINT, BIGINT);
...
GRANT EXECUTE ON FUNCTION has_user_reviewed_itinerary(BIGINT, BIGINT) TO authenticated;

-- Migration completed successfully
-- Remember to run this script in your Supabase SQL editor
-- All foreign key references now use BIGINT to match your existing schema
