...
class CustomAuthService {
  async login(email: string, password: string): Promise<AuthResponse> {
    try {
      ...
      if (profileError) {
        console.log("User lookup error:", profileError);
  ...
  async register(
    ...
    try {
      ...
      try {
        // Check if user already exists directly
      ...
      try {
        ...
        console.log("Insert user result:", { data, insertError });
        ...
        if (role === "tour_guide") {
          try {
            ...
            if (tourGuideError) {
              console.error(
                "Tour guide profile creation error:",
                tourGuideError
              );
            ...
            console.error(
              "Exception during tour guide profile creation:",
              error
            );
        ...
        const mappedRole: UserRole =
          role === "tour_guide" ? "tour_guide" : "user";
