...
export const bookings: Booking[] = [
    {
        ...
        participants: 4,
        status: "confirmed",
        specialRequests: "We would like to visit Tanah Lot temple at sunset if possible.",
    ...
    },
    {
        ...
        participants: 4,
        status: "confirmed",
        specialRequests: "We are all experienced hikers but would like extra water supplies.",
    ...
    },
    {
        ...
        participants: 2,
        status: "confirmed",
        specialRequests: "Interested in photography opportunities, bringing professional camera equipment.",
    ...
    },
    {
        ...
        participants: 4,
        status: "confirmed",
        specialRequests: "We have our own diving gear. All divers are PADI Advanced Open Water certified.",
    ...
    },
    {
        ...
        participants: 1,
        status: "pending",
        specialRequests: "Professional photographer, bringing multiple lenses and tripods.",
    ...
    },
    {
        ...
        participants: 3,
        status: "pending",
        specialRequests: "One person in our group has limited mobility and may need assistance on trails.",
    ...
    },
    {
        ...
        participants: 5,
        status: "confirmed",
        specialRequests: "Would like to perform a small private ceremony at one of the temples if possible.",
