import { AnalyticsData, AnalyticsItem, AnalyticsReport, AnalyticsMetric, AnalyticsReportType } from "../types";
...
export const analyticsData: AnalyticsData = {
    ...
    timeSeries: {
        bookings: [
            ...
            { date: '2025-05-01', value: 187 },
            { date: '2025-06-01', value: 324 },
        ],
        revenue: [
            { date: '2025-01-01', value: 16750 },
            { date: '2025-02-01', value: 18920 },
            { date: '2025-03-01', value: 22340 },
            { date: '2025-04-01', value: 27800 },
            { date: '2025-05-01', value: 34650 },
            { date: '2025-06-01', value: 45680 },
        ],
        users: [
            { date: '2025-01-01', value: 856 },
            { date: '2025-02-01', value: 912 },
            { date: '2025-03-01', value: 978 },
            { date: '2025-04-01', value: 1045 },
            { date: '2025-05-01', value: 1123 },
            { date: '2025-06-01', value: 1247 },
        ]
    },
    topDestinations: [
    ...
    reports: [
        ...
        },
        {
            ...
            description: 'Evaluation of tour guides by bookings, revenue, and ratings',
            type: 'guides',
            period: 'quarterly',
...
export const getTopDestinations = (limit: number = 5): typeof analyticsData.topDestinations => {
    return analyticsData.topDestinations.slice(0, limit);
};

export const getTopTourGuides = (limit: number = 5): typeof analyticsData.topTourGuides => {
...
export const getReportsByType = (type: AnalyticsReportType): AnalyticsReport[] => {
    return analyticsData.reports.filter(report => report.type === type);
};

export const createReport = (report: Omit<AnalyticsReport, 'id'>): AnalyticsReport => {
...
export const updateReport = (id: string, updates: Partial<AnalyticsReport>): AnalyticsReport | null => {
...
export const deleteReport = (id: string): boolean => {
    ...
    analyticsData.reports = analyticsData.reports.filter(report => report.id !== id);
