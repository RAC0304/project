...
interface AllActivitiesModalProps {
  ...
  onChatWithTourGuide?: (activity: ActivityItem) => void;
}
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 text-sm max-w-sm mx-auto">
                Start exploring and booking tours to build your activity
                history!
              </p>
            </div>
          ) : (
                          ...
                          <div className="flex items-start space-x-3 flex-1">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                >
                                  {/* Show specific activity type for bookings */}
                                  {activity.type === "booking" &&
                                ...
                                <div className="flex items-center">
                                  {activity.details && (
                                    <div className="text-xs text-gray-500">
                                      {/* For legacy booking activities without activityType */}
                                      {activity.type === "booking" &&
                                        !activity.details.activityType &&
                                  ...
                                  {/* Chat Tour Guide button for paid bookings */}
                                  {onChatWithTourGuide &&
                                    activity.type === "booking" &&
                                    activity.details &&
                                    activity.details.activityType ===
                                      ...
                                      <button
                                        onClick={() =>
                                          onChatWithTourGuide(activity)
                                        }
                                        className="ml-2 inline-flex items-center px-2.5 py-1 bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium rounded transition-colors"
                                      >
                                        💬 Chat Tour Guide
                                      </button>
                                    )}
