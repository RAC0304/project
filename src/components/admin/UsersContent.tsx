...
const UsersContent: React.FC<UsersContentProps> = ({ user }) => {
    // Display admin name in header welcome back
    const adminName = `${user?.profile.firstName || ''} ${user?.profile.lastName || ''}`;
    ...
    const validateForm = (): boolean => {
        ...
        if (modalMode === 'edit') {
            ...
            if (otherUsers.some(u => u.email.toLowerCase() === formData.email.toLowerCase())) {
                errors.email = 'This email is already in use';
            }
        }
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (modalMode === 'add') {
            ...
            showNotification('success', `User ${formData.firstName} ${formData.lastName} added successfully!`);
        } else {
            ...
            setUsers(prevUsers => prevUsers.map(u =>
                u.id === formData.id
                    ? {
                        ...
                        isActive: formData.isActive !== undefined ? formData.isActive : u.isActive
                    }
                    : u
            ));
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-green-50 p-4 rounded-lg border border-green-100">
                        ...
                        <div className="text-2xl font-bold">{users.filter(u => u.role === 'tour_guide').length}</div>
                    </div>
                            ...
                            {currentUsers.length > 0 ? (
                                currentUsers.map((user) => (
                                    <tr key={user.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm text-gray-900">{user.profile.location || 'Not set'}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="px-6 py-4 flex items-center justify-between border-t border-gray-200 bg-white">
                        <div className="flex-1 flex justify-between sm:hidden">
                            ...
                            <button
                                ...
                                className={`ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md ${currentPage >= Math.ceil(filteredUsers.length / usersPerPage) ? 'bg-gray-100 text-gray-400' : 'bg-white text-gray-700 hover:bg-gray-50'
                                    }`}
                            >
                                Next
                            </button>
                            ...
                            <div>
                                <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                                    ...
                                    <button
                                        onClick={() => paginate(currentPage + 1)}
                                        disabled={currentPage >= Math.ceil(filteredUsers.length / usersPerPage)}
                                        className={`relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium ${currentPage >= Math.ceil(filteredUsers.length / usersPerPage) ? 'text-gray-300' : 'text-gray-500 hover:bg-gray-50'
                                            }`}
                                    >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex flex-col items-center mb-2">
                                    ...
                                    >
                                        ...
                                        <span>{formData.avatar || previewImage ? 'Change Avatar' : 'Upload Avatar'}</span>
                                    </button>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`block w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 ${formErrors.firstName ? 'border-red-500' : 'border-gray-300'
                                                }`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className={`block w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 ${formErrors.lastName ? 'border-red-500' : 'border-gray-300'
                                                }`}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className={`block w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 ${formErrors.username ? 'border-red-500' : 'border-gray-300'
                                                }`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className={`block w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 ${formErrors.email ? 'border-red-500' : 'border-gray-300'
                                                }`}
                            ...
                            <div className="flex items-center mb-6">
                                ...
                                <div className="ml-4">
                                    ...
                                    <div className="flex items-center mt-1">
                                        ...
                                        <span className={`ml-2 px-2 inline-flex text-xs leading-5 font-medium rounded-full ${selectedUser.isActive
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="text-sm font-medium text-teal-600">{selectedUser.email}</p>
                                                </div>
                                            </div>
                                            <div>
