...
const MessagesContent: React.FC<MessagesContentProps> = ({ messages = [], isLoading = false }) => {
    ...
    const defaultMessages: Message[] = [
        {
            ...
            preview: "Hi! I wanted to ask about the meeting point for tomorrow's tour...",
            isUnread: true,
            messages: [
                {
                    content: "Hi! I wanted to ask about the meeting point for tomorrow's tour. Will it be at the Colosseum entrance or somewhere else?",
        ...
        },
        {
            ...
            preview: "The Vatican tour was incredible. Thank you for making it so special...",
            messages: [
                {
                    content: "The Vatican tour was incredible. Thank you for making it so special. Your knowledge of the art and history made everything come alive!",
                    timestamp: "1 day ago",
                    isFromGuide: false
                },
                {
                    content: "Thank you for your kind words, David! It was my pleasure to show you around the Vatican. I'm glad you enjoyed the experience!",
        ...
        },
        {
            ...
            messages: [
                {
                    content: "Could you please confirm our booking for the Colosseum tour? We're a group of 4 and would like to do it next Tuesday.",
                    timestamp: "3 days ago",
                    isFromGuide: false
                },
                {
                    content: "Hi Emma! Yes, I can confirm your booking for next Tuesday. The tour will start at 9 AM at the Colosseum entrance.",
                    timestamp: "3 days ago",
                    isFromGuide: true
                },
                {
    ...
    const handleReply = () => {
        ...
        const updatedMessages = messages.length > 0 ? [...messages] : [...defaultMessages];
                                ...
                                <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-3">
                                            ...
                                            <div className="text-sm text-gray-500">{message.sender.time}</div>
                                        </div>
                                    </div>
                                    {message.isUnread && (
                                        <div className="flex items-center">
