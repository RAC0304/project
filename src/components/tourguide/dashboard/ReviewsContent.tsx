...
const ReviewsContent: React.FC<ReviewsContentProps> = ({ tourGuideId }) => {
    ...
    useEffect(() => {
        const sampleReviews: Review[] = [
            {
                ...
                clientEmail: 'emily@wanderwise.com',
                rating: 5,
                title: 'Amazing Cultural Experience!',
                content: 'The temple tour was absolutely incredible. Our guide was knowledgeable and passionate about Balinese culture. The sunset at Tanah Lot was breathtaking. Highly recommend this tour to anyone visiting Bali!',
                date: '2025-05-20T10:30:00Z',
                tourDate: '2025-05-15',
                verified: true,
                helpful: 12,
                response: 'Thank you so much for your wonderful review, Emily! It was a pleasure sharing the beauty of Balinese culture with you. Hope to see you again soon!',
                responseDate: '2025-05-21T08:15:00Z'
            },
            {
                id: 'review-002',
                tourId: 'tour-002',
                ...
                rating: 4,
                title: 'Great insight into local crafts',
                content: 'Loved learning about traditional Balinese crafts. The batik workshop was particularly interesting. Only minor issue was the transportation being a bit delayed.',
                date: '2025-05-18T14:20:00Z',
                tourDate: '2025-05-12',
                verified: true,
                helpful: 8
            },
            {
                ...
                content: 'Everything was perfectly organized. The guide was friendly and informative. The temples were beautiful and the explanations helped us understand the significance of each site.',
            ...
            },
            {
                ...
                content: 'Great variety of street food and excellent explanations about Indonesian cuisine. Some locations were quite crowded but that added to the authentic experience.',
            ...
            },
            {
                ...
                content: 'The tour was informative but felt a bit rushed. Would have liked more time at each workshop to really engage with the artisans.',
        ...
        // Filter reviews for this tour guide
        const guideReviews = sampleReviews.filter(() =>
            // In a real app, you'd filter by tour guide ID
            // For now, we'll show all reviews as sample data
            true
        );

        setReviews(guideReviews);
        setFilteredReviews(guideReviews);
    }, [tourGuideId]);
                ...
                <div className="bg-white p-4 rounded-lg shadow-md">
                    <div className="flex items-center">
                        ...
                        <div className="ml-3">
                            ...
                            <p className="text-xl font-semibold text-gray-900">{reviews.length}</p>
                        </div>
                    </div>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md">
                    <div className="flex items-center">
                        ...
                        <div className="ml-3">
                            ...
                            <p className="text-xl font-semibold text-gray-900">{responseRate.toFixed(1)}%</p>
                        </div>
                    </div>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-md">
                    <div className="flex items-center">
                        ...
                        <div className="ml-3">
                            ...
                            <p className="text-xl font-semibold text-gray-900">{ratingDistribution[5]}</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div key={review.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                                <div className="flex items-start justify-between mb-3">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-3">
                                            <h3 className="text-sm font-medium text-gray-900">{review.clientName}</h3>
                        ...
                        <div className="p-6">
                            <div className="flex items-start mb-6">
                                ...
                                <div className="ml-4 flex-1">
                                    <h3 className="text-lg font-semibold text-gray-900">{selectedReview.clientName}</h3>
                                    <div className="flex items-center mt-1">
                                    ...
                                    <div className="mt-2 text-sm text-gray-600">
                                        <span className="font-medium">Tour:</span> {selectedReview.tourName}
                                    </div>
                                    <div className="text-sm text-gray-600">
                                        <span className="font-medium">Tour Date:</span> {formatDate(selectedReview.tourDate)}
                                    </div>
                                </div>
                            </div>
