...
import { X, Calendar, MapPin, Users, Clock, DollarSign, Star } from 'lucide-react';
                        ...
                        <>
                            ...
                            <div className="bg-teal-50 p-4 rounded-lg">
                                <div className="flex items-center justify-between mb-2">
                                    <h3 className="text-lg font-semibold text-gray-900">{tourDetails.title}</h3>
                                ...
                                <div className="flex items-center text-gray-600">
                                    ...
                                    <span>{formatDate(tour.date)} at {tour.time}</span>
                                </div>
                                <p className="text-sm text-gray-600 mt-2">Tour ID: #{tour.id}</p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <div className="bg-green-50 rounded-xl p-4 text-center">
                                    ...
                                    <div className="font-medium">{formatCurrency(tourDetails.price)}</div>
                                </div>
                                ...
                                <div className="bg-purple-50 rounded-xl p-4 text-center">
                                    <div className={`h-6 w-6 mx-auto mb-2 rounded-full flex items-center justify-center ${
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                                <h4 className="font-medium text-gray-900 mb-3">Current Booking Information</h4>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                    <div>
                                        <span className="text-gray-500">Scheduled Date:</span>
                                        <span className="ml-2 font-medium">{formatDate(tour.date)}</span>
                                    </div>
                                    <div>
                                        <span className="text-gray-500">Time:</span>
                                        <span className="ml-2 font-medium">{tour.time || 'Not specified'}</span>
                                    </div>
                                    <div>
                                        <span className="text-gray-500">Booked Clients:</span>
                                        <span className="ml-2 font-medium">{tour.clients} people</span>
                                    </div>
                                    <div>
                                    ...
                                    {tourDetails.destinations && (
                                        <div>
                                            ...
                                            <span className="ml-2 font-medium">{tourDetails.destinations.name}</span>
                                        </div>
                                    )}
                                    {tourDetails.created_at && (
                                        <div>
                                            <span className="text-gray-500">Tour Created:</span>
                                            <span className="ml-2 font-medium">{new Date(tourDetails.created_at).toLocaleDateString('id-ID')}</span>
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="bg-gradient-to-r from-teal-50 to-blue-50 p-4 rounded-lg">
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    <div>
                                        ...
                                        <span className="ml-2 font-medium">{tour.clients} participants</span>
                                    </div>
                                    <div>
                                        <span className="text-gray-500">Booking Status:</span>
