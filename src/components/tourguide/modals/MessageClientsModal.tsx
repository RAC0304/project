...
const MessageClientsModal: React.FC<MessageClientsModalProps> = ({ tour, isOpen, onClose }) => {
    ...
    // Mock client data - in a real app, this would come from your API
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-lg shadow-xl w-full max-w-md text-center p-8">
                    ...
                    <p className="text-gray-600">
                        Your message has been sent to {selectedClients.length} client{selectedClients.length > 1 ? 's' : ''}.
                    </p>
                </div>
            </div>
        );
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center p-6 border-b">
                    <h2 className="text-xl font-semibold text-gray-900">Message Clients</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="space-y-3 max-h-48 overflow-y-auto border rounded-lg p-3">
                            {mockClients.map((client) => (
                                <div
                                    key={client.id}
                                    className={`flex items-center space-x-3 p-3 rounded-lg cursor-pointer transition-colors ${selectedClients.includes(client.id)
                    ...
                    <form onSubmit={handleSendMessage} className="space-y-4">
                        ...
                        <div className="flex justify-end space-x-3 pt-4">
                            ...
                            <button
                                type="submit"
                                disabled={!message.trim() || selectedClients.length === 0 || isSending}
