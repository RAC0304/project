...
const IndonesiaMapLeaflet: React.FC<IndonesiaMapLeafletProps> = ({
  ...
  return (
    <div className={`indonesia-map-container relative z-10 ${className}`}>
      <div className="indonesia-map-leaflet w-full rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow relative z-10">        <MapContainer
        ref={mapRef}
        style={{
          height,
          width: "100%",
      ...
      >
        ...
        {/* Indonesia GeoJSON data */}          <GeoJSON
        ...
        <div className="leaflet-top leaflet-left" style={{
          ...
          <div className="leaflet-control bg-white p-2 rounded-lg shadow-md" style={{ pointerEvents: "auto" }}>
            <div className="text-sm font-medium mb-1 text-center">Description</div>
