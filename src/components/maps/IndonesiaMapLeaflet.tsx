...
import { indonesiaGeoData, RegionProperties, majorCities, popularDestinations, mainIslands } from '../../data/indonesiaGeoData';
...
const IndonesiaMapLeaflet: React.FC<IndonesiaMapLeafletProps> = ({
    ...
    const [activeIsland, setActiveIsland] = useState<string | null>(null);    // Fix Leaflet icon on component mount
    useEffect(() => {
        fixLeafletIcon();
    ...
    const onEachFeature = (feature: any, layer: L.Layer) => {
        ...
        <div class="leaflet-popup-content-custom">
          ...
          ${feature.properties.destinations ?
                    `<p class="text-xs text-gray-600">Key destinations: ${feature.properties.destinations.join(', ')}</p>` : ''}
                            ...
                            <Popup>
                                <div>
                                    ...
                                    <button
                                        ...
                                        onClick={() => navigate(`/destinations?search=${dest.name}`)}
                                    >
                                        View Details
                                    </button>
                                </div>
