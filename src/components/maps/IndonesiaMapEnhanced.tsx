...
const IndonesiaMap: React.FC<IndonesiaMapProps> = ({ className = '' }) => {
    ...
    return (
        <div className={`indonesia-map-container relative ${className}`}>
            <div className="indonesia-map w-full max-w-4xl mx-auto bg-teal-50/50 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
              ...
              `}
                        ...
                        />
                        <text className="island-label" x="230" y="260">Sumatra</text>
                        ...
                        />
                        <text className="island-label" x="480" y="382">Java</text>
                        ...
                        />
                        <text className="island-label" x="510" y="240">Kalimantan</text>
                        ...
                        />
                        <text className="island-label" x="675" y="260">Sulawesi</text>
                        ...
                        />
                        <text className="island-label" x="840" y="270">Papua</text>
                        ...
                        />
                        <text className="small-island-label" x="658" y="420">Bali</text>
                        ...
                        />
                        <text className="small-island-label" x="686" y="420">Lombok</text>
                        ...
                        />
                        <text className="small-island-label" x="720" y="425">Flores</text>
                        ...
                        />
                        <text className="small-island-label" x="800" y="440">Timor</text>
                        ...
                        <path
                            ...
                            onClick={() => handleRegionClick('Maluku')}
                        />
                        <text className="small-island-label" x="780" y="350">Maluku</text>

                        {/* Compass rose */}
                        <g transform="translate(900, 100)">
                            <circle cx="0" cy="0" r="30" fill="#ecfdf5" stroke="#047857" strokeWidth="2" />
                            ...
                            <text x="0" y="-32" textAnchor="middle" fontFamily="Arial" fontSize="12" fill="#047857">N</text>
                            <text x="0" y="40" textAnchor="middle" fontFamily="Arial" fontSize="12" fill="#047857">S</text>
                            <text x="-32" y="4" textAnchor="middle" fontFamily="Arial" fontSize="12" fill="#047857">W</text>
                            <text x="32" y="4" textAnchor="middle" fontFamily="Arial" fontSize="12" fill="#047857">E</text>
                        </g>
                        ...
                        <g transform="translate(100, 500)">
                            ...
                            <text x="0" y="20" fontFamily="Arial" fontSize="12" fill="#047857">0</text>
                            <text x="100" y="20" fontFamily="Arial" fontSize="12" fill="#047857">500km</text>
                            <text x="200" y="20" fontFamily="Arial" fontSize="12" fill="#047857">1000km</text>
                        </g>
                    </svg>
                </div>
            </div>      <div className="text-center mt-4 text-gray-600">
                <p className="mb-1 font-medium">Jelajahi Indonesia dari peta</p>
                <p className="text-sm">Klik pada pulau untuk melihat destinasi di daerah tersebut</p>
            </div>
        </div>
    );
};
