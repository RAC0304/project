...
const IndonesiaMap: React.FC<IndonesiaMapProps> = ({ className = "" }) => {
  ...
  return (
    <div className={`indonesia-map-container relative z-10 ${className}`}>
      <div className="indonesia-map w-full max-w-3xl mx-auto relative z-10">
        <svg
        ...
        >
          ...
          />
          <text className="label" x="180" y="150">
            Sumatra
          </text>
          ...
          />
          <text className="label" x="360" y="245">
            Java
          </text>
          ...
          />
          <text className="label" x="370" y="175">
            Kalimantan
          </text>
          ...
          />
          <text className="label" x="520" y="200">
            Sulawesi
          </text>
          ...
          />
          <text className="label" x="650" y="195">
            Papua
          </text>
          ...
          />
          <text className="label" x="480" y="275">
            Bali
          </text>
          ...
          />
          <text className="label" x="500" y="275">
            Lombok
          </text>
          ...
          />
          <text className="label" x="530" y="280">
            Flores
          </text>
          ...
          />
          <text className="label" x="570" y="280">
            Timor
          </text>
        </svg>
      </div>
