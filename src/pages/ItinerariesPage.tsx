        ...
        <div className="mt-16 bg-teal-900 text-white rounded-xl overflow-hidden">
          <div className="md:flex">
            ...
            <div className="p-8 md:w-3/5">
              ...
              <p className="mb-6">
                Our travel experts can help you create a personalized journey
                based on your interests, schedule, and budget. Get the perfect
                Indonesian adventure tailored just for you.
              </p>
