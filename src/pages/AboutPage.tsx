            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
                  <li>
                    <strong>Dry Season (April to October):</strong> Generally
                    the best time to visit most regions.
                  </li>
                  <li>
                    <strong>Wet Season (November to March):</strong> Expect
                    brief, heavy downpours, typically in the afternoon.
                  </li>
                </ul>
                <p className="text-gray-700">
                  The ideal time to visit depends on your specific destinations.
                  Bali and Java are pleasant year-round, while Raja Ampat is
                  best experienced from October to April.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  Many nationalities can enter Indonesia visa-free for stays up
                  to 30 days. For longer stays, consider these options:
                </p>
                <ul className="list-disc list-inside text-gray-700 space-y-2">
                  <li>
                    <strong>Visa-Free:</strong> 30 days, non-extendable
                  </li>
                  <li>
                    <strong>Visa on Arrival:</strong> 30 days, extendable once
                    for another 30 days
                  </li>
                  <li>
                    <strong>Tourist Visa:</strong> Apply at Indonesian embassies
                    before arrival
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2">
                  <li>
                    <strong>Flights:</strong> The fastest way to travel between
                    islands, with numerous domestic carriers
                  </li>
                  <li>
                    <strong>Ferries and Boats:</strong> Connect many islands,
                    from large passenger ferries to small local boats
                  </li>
                  <li>
                    <strong>Trains:</strong> Available on Java and Sumatra,
                    comfortable and affordable
                  </li>
                  <li>
                    <strong>Cars and Taxis:</strong> Readily available in major
                    cities and tourist areas
                  </li>
                  <li>
                    <strong>Ride-sharing:</strong> Gojek and Grab operate in
                    most urban areas
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2">
                  ...
                  <li>
                    Ask permission before photographing people, especially in
                    rural areas
                  </li>
                  <li>
                    Learn a few basic Indonesian phrases—locals appreciate the
                    effort
                  </li>
                  <li>
